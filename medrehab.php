      ...
      <div class="col-lg-6 d-flex flex-column justify-content-center about-content" style="padding-top: 0px; margin-top: 0px;">
            ...
            <div data-aos="fade-up" data-aos-delay="100" style="padding-bottom: 0px; margin-bottom: 0px;">
              <p class="description" align-="justify">
                 <h2>FACULTY OF MEDICAL REHABILITATION</h2>
          <span style="font-style: italic; font-weight: bold;">DEPARTMENT OF PHYSIOTHERAPY</span><br /> 
      <strong>A.  Master of Science degree programme in Physiotherapy (Physiotherapy)</strong><br />
      <strong>  B.  Doctor of Philosophy in Physiotherapy (Ph.D. (Physiotherapy))</strong><br />
          Admission Requirements<br />
      <p>
          
        </p>
        <h6>
          <a href="pg_docs/20232024 PG DVERT.pdf" target="_blank">&rArr;<strong>CLICK HERE FOR ADMISSION REQUIREMENTS</strong></a>
        </h6>
