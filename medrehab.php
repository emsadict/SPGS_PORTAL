...
<body>
  ...
  <main id="main">
    ...
    <div class="container">
  <div class="row">
    <!-- Left Column: Faculty of Medical Rehabilitation Programmes -->
    <div class="col-lg-6">
      <div class="section-title">
        <h4><strong>FACULTY OF MEDICAL REHABILITATION</strong></h4>

        <h5><strong>DEPARTMENT OF PHYSIOTHERAPY</strong></h5>
        <p class="description">
          • Master of Science (MSc) in Physiotherapy<br />
          <em>Programme duration: 18 months</em>
        </p>
        <p class="description">
          • Master of Clinical Physiotherapy (MClin. Physiotherapy)<br />
          <em>Professional Master’s Degree</em>
        </p>
        <p class="description">
          • Doctor of Philosophy (PhD) in Physiotherapy<br />
          <em>Programme duration: 6 semesters</em>
        </p>
      </div>
    </div>
