  ...
  <main id="main">
    ...
    <section id="about" class="about">
      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="container">
  <div class="row">
    <!-- Left Column: Faculty of Allied Health Sciences Programmes -->
    <div class="col-lg-6">
      <div class="section-title">
        <h4><strong>FACULTY OF ALLIED HEALTH SCIENCES</strong></h4>

        <h5><strong>DEPARTMENT OF MEDICAL LABORATORY SCIENCE</strong></h5>
        <p class="description">
          • Master of Science (MSc) in Medical Laboratory Science<br />
          • Master of Philosophy/Doctor of Philosophy (MPhil/PhD) in Medical Laboratory Science<br />
          • Doctor of Philosophy (PhD) in Medical Laboratory Science
        </p>

        <p class="description">
          <strong>Specializations Available:</strong><br />
          • Public Health Microbiology and Parasitology<br />
          • Chemical Pathology<br />
          • Blood Transfusion Science and Hematology<br />
