...
if(isset($_REQUEST["submit"]) && $_REQUEST["pass"]!=""){
	if(searchRecord("spgs_acc","username",$_REQUEST['regno'])==0){
		$message="Applicant Account Not Found";
	}elseif(accLogin1($_REQUEST['regno'],$_REQUEST['pass'],"spgs_acc")==0){
		$message="Invalid or Wrong Password, your Transaction Id is your password please";
	}else{
		$_SESSION['spgs_auth']=accLogin1($_REQUEST['regno'],$_REQUEST['pass'],"spgs_acc");
...
<head>
  ...
  <title>LOGIN PAGE - SCHOOL OF POSTGRADUATE::University of Medical Sciences, Ondo</title>
			...
			?>
              <div class="row text-center">
                <div class="col-lg-12 form-group">
                  ...
                  <input type="text" name="regno" name="regno" class="form-control" id="regno" placeholder="APPLICATION NO" required>
                </div>
              </div>
			  <div class="row text-center">
                <div class="col-lg-12 form-group">
