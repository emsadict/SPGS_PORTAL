...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      ...
      <div class="container">
  <div class="row">
    <!-- Left Column: General Entry Requirements -->
    <div class="col-lg-6">
    ...
    <!-- Right Column: Programmes Offered -->
    <div class="col-lg-6">
      <div class="section-title">
        <h4><strong>FACULTY OF BASIC MEDICAL SCIENCES</strong></h4>

        <h5><strong>A. DEPARTMENT OF ANATOMY</strong></h5>
        <p class="description">
          MSc, MPhil, MPhil/PhD & PhD in:<br />
          • Biological Anthropology and Forensic Science<br />
          • Medical Genetics and Molecular Biology<br />
          • Neuroscience and Endocrinology
        </p>

        <h5><strong>B. DEPARTMENT OF BIOCHEMISTRY</strong></h5>
        <p class="description">
          • PGD in Applied Biochemistry<br />
          • MSc, MPhil, MPhil/PhD & PhD in Biochemistry<br />
          <strong>Specializations:</strong><br />
          • Clinical Biochemistry<br />
          • Phytomedicine and Toxicology<br />
          • Enzymology<br />
          • Industrial and Process Biochemistry<br />
          • Nutritional Biochemistry<br />
          • Membrane Biochemistry<br />
          • Biochemical Biotechnology
        </p>

        <h5><strong>C. DEPARTMENT OF PHYSIOLOGY</strong></h5>
        <p class="description">
          MSc, MPhil, MPhil/PhD & PhD in:<br />
          • Endocrinology/Metabolism<br />
          • Reproduction and Fetal Monitoring<br />
          • Cardiovascular and Respiratory Physiology<br />
          • Gastrointestinal Physiology<br />
          • Renal Physiology<br />
          • Neurophysiology<br />
          • Nutrition Physiology<br />
