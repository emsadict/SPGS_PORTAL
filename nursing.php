...
<body>
 ...
 <div class="container">
  <div class="row">
    <!-- Left Column: Faculty of Nursing Science Programmes -->
    <div class="col-lg-6">
      <div class="section-title">
        <h4><strong>FACULTY OF NURSING SCIENCE</strong></h4>
        <p class="description">
          Applications are invited from suitably qualified candidates for admission into the Postgraduate Nursing Programmes:
        </p>
        <p class="description">
          • Postgraduate Diploma in Nursing Education (PGDNE)<br />
          • Master of Science in Nursing (MSc)<br />
          • Doctor of Philosophy in Nursing (PhD)
        </p>
        <p class="description">
          <strong>MSc and PhD Specializations:</strong><br />
          • Adult Health Nursing<br />
          • Community Health Nursing<br />
          • Maternal, Neonatal and Child Health Nursing<br />
          • Nursing Education<br />
          • Mental Health Nursing <em>(currently not available)</em>
        </p>
      </div>
    </div>
