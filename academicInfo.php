      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
         ...
         <div class="form-group">
					...
					<input type="file" id="imageInput2" name="olevel1"  accept="image/jpg" class="form-control" />
         ...
         <div class="row">
				<div class="form-group">
					...
					<input type="file" id="imageInput" name="olevel2"  accept="image/jpg" class="form-control" />
