...
//	$paystatus=retInvoiceP("PUH/22/3994","UNIMED SPGS SCHOOL FEE","2022/2023");
    ...
    if($paystatus==0)
    {
       ...
       // echo $paystatus;
        ...
        //alert to pay school fees first

        echo ("<script LANGUAGE='JavaScript'>

                window.alert('You have to pay your school fee first');
        ...
        //end alert to pay school fee first

    }
        if($sessionRec=='2021/2022' &&  $programme=='Postgraduate Diploma' )
        {

        		echo ("<script LANGUAGE='JavaScript'>

                window.alert('Your academic session has ended');
        ...
        if($sessionRec=='2021/2022' && $programme=='Masters')
        {
    ...
    $amoutPaid=getSumPaid($user,"UNIMED SPGS SCHOOL FEE",$sessionRec);
...
// username='$user'-->  
    ...
    $brec=getRecs("Screened_Candidates_2022","regno",$user);
...
//    exit();
	...
	}elseif($user!="" && input($info,"course_reg")){

		if($level==100){

			$message="Courses Successfully Submited, Continue to Print[<a href=\"course_reg_Reg.php\">Out Your Course Form</a>]";
...
//  $semester="SECOND";
            ...
            <tr style="background-color:#063958; color:#fff;">	
			 ...
			 <tr style="background-color:#0099FF; color:#ffffff;">	
				...
				<td colspan="12" align="center" style="padding:5px;"><strong><?php echo 'Session: '. $session ; ?></strong></br>

				<strong><?php  echo  'Dept: '. $dept ?></strong></br>

				<strong><?php  echo  'Programme: '. $programme ?></strong></br>

				<strong> <?php echo  'Semester: '. $semester   ?></br>

				<strong><?php  echo  'Level: '. $level ?></strong>
            ...
            <tr style="background-color:#FFF; color:#F00; font-style:italic;">	
				...
				<td colspan="5" align="center" style="padding:5px;">Please Note that you are to tick appropriately and submit<!--[&nbsp;<a href="courseregistration.php?delreg=0" style="color: #00F; font-weight: bold; font-style: normal;">Reset Courses</a>&nbsp;]--></td>
            ...
            <?php
		  	...
		  	listCoursesNew($dept,$level,$semester,$user,1,"REGULAR");
				...
				<input type="submit" class="btn btn-success" name="submit" onclick="return confirm(\'Kindly review your record, Are you sure you want to Submit?\')"  value="&nbsp;Submit Course Form!&nbsp;"  class="button" />				</td>
