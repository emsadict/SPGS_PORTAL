...
//	ini_set('display_startup_errors', 1);
	...
	//	$retinv=retInvoiceP($user,"UNIMED SPGS APPLICATION FEE",$cal[1]);
		...
		case "Postgraduate Diploma":
			$cos=array('PGDPH','PGDEHSM','PGDHS','PGDNE','PG Dip.');
			break;
		case "Masters":
...
//							$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
							...
							$mail->Body    = '<div style="width:100%; font-family:Verdana, Geneva, sans-serif;
								font-size:13px; color:#666; background-color:#fff; border:1px solid #ddd; text-align:justify;">
									...
									<tr>
										...
										<br /><br />
										Kindly <a href="https://spgs.unimed.edu.ng/referee_recommendation.php?regid='.$regno.'&id='.$refno.'" target="_blank">Click Here</a> for your recommendations. You are expected to complete the form on or before '.$format_deadline.'
										<br /><br />
							...
							$mail->AltBody = 'Kindly visit  https://spgs.unimed.edu.ng/referee_recommendation.php?regid='.$regno.'&id='.$refno.' for your recommendations. You are expected to complete the form on or before '.$format_deadline;
        ...
        <div class="row">
         ...
         <div class="col-lg-3 form-group">
				...
				<div class="form-group">
					...
					<input type="file" id="imageInput" name="passport" class="form-control" accept="image/jpg" id="passport" />
        </div>
        </div>
