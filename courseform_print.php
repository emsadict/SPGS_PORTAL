...
<head>
  ...
  <title>Result Checker POSTGRADUATESCHOOL::University of Medical Sciences, Ondo</title>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>POST GRADUATE STUDENTS RESULT CHECKING PORTAL</h2>
        </div>
...
<form action="courseform.php" target="_BLANK" method="post" name="formcheck" onsubmit="return formCheck(this);" role="form" class="php-email-form">
			<?php
				if(isset($message)){
