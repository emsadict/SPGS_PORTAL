...
<body>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <h4 class="title">AVAILABLE POSTGRADUATE PROGRAMMES</h4>
                ...
                <div class="container">
  <div class="row">
    <!-- Left Column: Faculty of Science Programmes -->
    <div class="col-lg-6">
      <div class="section-title">
        <h4><strong>FACULTY OF SCIENCE</strong></h4>

        <h5><strong>A. DEPARTMENT OF BIOSCIENCES AND BIOTECHNOLOGY</strong></h5>
        <p class="description">
          • PGD, MSc, PhD in:<br />
          - Forensic Biology and Genetic Counseling<br />
          - Parasitology and Pathobiology<br />
          - Environmental Biotechnology
        </p>
        <p class="description">
          <strong>PLANT BIOLOGY AND BIOTECHNOLOGY (MSc/MPhil/PhD)</strong><br />
          - Phytomedicine<br />
          - Plant Physiology<br />
          - Plant Ecology<br />
          - Plant Anatomy<br />
        ...
        <p class="description">
          <strong>ANIMAL AND ENVIRONMENTAL BIOLOGY (MSc/MPhil/PhD)</strong><br />
          - Molecular Parasitology<br />
          - Genetics and Biotechnology<br />
          - Environmental Biology and Toxicology
        </p>

        <h5><strong>B. DEPARTMENT OF MATHEMATICAL AND COMPUTER SCIENCE</strong></h5>
        <p class="description">
          <strong>M.Sc. Mathematics</strong><br />
          - Mathematical Biology<br />
          - Numerical Analysis<br />
          <strong>Ph.D. Mathematics</strong><br />
          - Mathematical Biology<br />
          - Numerical Analysis
        </p>

        <h5><strong>C. DEPARTMENT OF PHYSICS</strong></h5>
        <p class="description">
          • MSc, MPhil, PhD in:<br />
          - Energy Studies and Economics<br />
          - Geophysics<br />
          - Biomedical/Medical Physics<br />
          - Electronic and Communication Physics<br />
          - Environmental and Health Physics
        </p>

        <h5><strong>D. DEPARTMENT OF CHEMISTRY</strong></h5>
        <p class="description">
          <strong>PGD in:</strong><br />
          - Industrial Chemistry<br />
          - Analytical and Environmental Chemistry<br />
          - Petrochemistry<br />
          <strong>Professional MSc in Industrial and Environmental Management</strong><br />
          - Environmental Pollution Control and Management<br />
          - Food and Pharmaceutical Science<br />
          - Industrial and Environmental Health and Safety<br />
          <strong>MSc, MPhil, MPhil/PhD, PhD Options:</strong><br />
          - Analytical and Environmental Chemistry<br />
          - Analytical and Forensic Chemistry<br />
          - Industrial Chemistry<br />
          - Inorganic Chemistry<br />
          - Medicinal and Organic Chemistry<br />
          - Physical and Computational Chemistry
        </p>

        <h5><strong>E. DEPARTMENT OF MICROBIOLOGY</strong></h5>
        <p class="description">
          • MSc, MPhil, MPhil/PhD, PhD in:<br />
          - Environmental Microbiology<br />
          - Food and Industrial Microbiology<br />
  ...
  <div class="row">
    <div class="col-lg-12 text-center" style="margin-top: 30px;">
      ...
      <h6>
        <a href="pg_docs/unimed_advert.pdf" target="_blank">&rArr; <strong>CLICK HERE FOR ADMISSION REQUIREMENTS</strong></a>
      </h6>
    </div>
  </div>
</div>
