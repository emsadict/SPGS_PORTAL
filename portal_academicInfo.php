...
if(isset($_REQUEST["update"])){
	if(searchRecord("portal_spgs_acad_rec","regno",$user)==0 && $_FILES['olevel1']['name']==""){
		...
		$message="Result file must not exceed 200kb";
		...
		//	if(input2($info,"spgs_acad_rec_2021_2022")){
			    	if(input2($info,"portal_spgs_acad_rec")){
			$message="Record Successfully Submited, [<a href=\"other_information.php\">Other Information</a>]";
				/*
...
<center><a href='#'target="_blank"><button class='btn btn-danger btn-sm' style='float:center; '>Print Student's Health Centre Form</button></a></center>
        ...
        <div class="row">
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
			...
			<?php 
				$rec=getRecs("portal_spgs_acad_rec","regno",$user);
				echo '
              <div class="row">
			...
			?>
              <div class="text-center"><button type="submit" onclick="return confirm(\'Kindly review your record, Are you sure you want to Submit?\')" name="update">Submit Academic Record</button></div>
            </form>
          </div>
 </div>
        </div>
