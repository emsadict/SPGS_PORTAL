...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE programme LIKE '%Postgraduate Diploma%' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `faculty`,`dept` ");
...
<head>
  ...
  <title>Applicants / Postgraduate Diploma</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">PGD</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<?php 
  ...
  /*
    ...
    echo "<th><a href='components-accordion.php'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>Masters</button></th>";
    ...
    */
    echo "<th><a href='#'  ><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>PGD</button></a></th>";
