...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Doctorate Applicants</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
          <li class="breadcrumb-item">Applications</li>
          <li class="breadcrumb-item active">Dcotorate</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Doctorate Applications</h5>
<?php 
              echo "</head>";
    //echo "<body>";
  ...
  /*
    ...
    echo "<th><a href='#'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>PhD</button></a></th>";
    /*
