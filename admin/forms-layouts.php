...
<?php include_once("sidebar.php"); ?>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Screening Portal</h5>
    ...
    echo "<div class='text-primary'><center><h2>Welcome to Doctorate Screening Portal</h2></center>";
    echo "<hr>";
   ...
   // echo "<th><a href='phd.php'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>PhD</button></a></th>";
    ...
    echo "<th><a href='admin-panel.php'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>Upload Screening List</button></a></th>";

    echo "<hr>";
    echo "<div class='text-primary'><center><h3>ALL ADMITTED </h3></center>";
    echo "</br>";
  ...
  //echo "<th>Delete Users</th>";
   ...
   //   echo "<th><img src='images/result/$ol1' height='100px' width='100px'></th>";
    ...
    echo "<div class='col-md-12 container-fluid  '>";
    echo "<div class='box container-fluid' style='border:1px solid grey; margin-top:40px;  padding:10px; border-radius: 5px; box-shadow: 3px 3px 3px gray; background-color:; float: center;'>";
    echo "<div class='text-primary'><center><h2>Welcome to Masters Screening Portal</h2></center>";
    echo "<hr>";
...
//  echo "<th>Delete Users</th>";
   ...
   //   echo "<th><img src='images/result/$ol1' height='100px' width='100px'></th>";
    ...
    echo "<div class='col-md-12 container-fluid  '>";
    echo "<div class='box container-fluid' style='border:1px solid grey; margin-top:40px;  padding:10px; border-radius: 5px; box-shadow: 3px 3px 3px gray; background-color:; float: center;'>";
    echo "<div class='text-primary'><center><h2>Welcome to Diploma Screening Portal</h2></center>";
    echo "<hr>";
