...
if (isset($_POST['download_csv'])) {
  ...
  $query = "SELECT * FROM matric_table_pg WHERE 1";
  ...
  header('Content-Disposition: attachment; filename="matric_records.csv"');

  $output = fopen('php://output', 'w');
  fputcsv($output, ['Regno', 'Matric No', 'Surname', 'Other Names', 'Department', 'Programme', 'Faculty', 'Session']);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View Student Email Address</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="card">
      <div class="card-body">
        <form method="POST" action="checkmatric.php" id="searchForm">
          <div class="row">
            <div class="col-md-4">
