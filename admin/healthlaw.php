...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE faculty LIKE '%Health Law and Humanitiess%' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `dept`,`programme` ");
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Faculty of Health Law and Humanities</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admindashboad.php">Home</a></li>
          <li class="breadcrumb-item">Application</li>
          <li class="breadcrumb-item active">Hlh</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
