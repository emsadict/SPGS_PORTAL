...
session_start();
 ...
 //  echo $role;
  //  $sessionRec=$admrecS['session'];
    ...
    $result = resultnew( "SELECT * FROM spgs_basicinfo WHERE programme LIKE '%Masters%' AND regno NOT IN (SELECT regno from admitted_2022) ORDER BY `faculty`,`dept` ");
...
<head>
  ...
  <title>Doctorate Applicants </title>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Masters Applications</h5>
<?php 
              echo "</head>";
    //echo "<body>";
    ...
    echo "<hr>";
    echo "Available Masters Applications:" . $row;
     /*
    ...
    echo "<th><a href='#'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>Masters</button></th>";

    echo "<th><a href='components-alerts.php'><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>PhD</button></a></th>";
    /*
    echo "<th><a href='pgd.php'  ><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>PGD_OLD</button></th>"; */
    
    echo "<th><a href='components-badges.php'  ><button class='btn btn-primary' style='float:right; margin-right:40px; padding:4px;'>PGD</button></a></th>"; 
