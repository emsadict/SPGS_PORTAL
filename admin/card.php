          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">All Students  <span>| in record</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo "Total Screened:<br />" .$row; ?></h6>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Masters <span>| Students</span></h5>
            ...
            <div class="col-xxl-3 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">PG Diploma <span>| Students</span></h5>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Doctorate <span>| Students</span></h5>
